import { hasInjectionContext, inject, version, unref, effectScope, ref, markRaw, defineComponent, provide, createElementBlock, computed, watch, h, shallowReactive, Suspense, nextTick, Fragment, Transition, mergeProps, useSSRContext, createApp, reactive, getCurrentScope, getCurrentInstance, isRef, isReactive, toRaw, onErrorCaptured, onServerPrefetch, createVNode, resolveDynamicComponent, toRef, onScopeDispose, defineAsyncComponent, shallowRef, isReadonly, toRefs, withCtx, isShallow } from 'vue';
import { $ as $fetch, l as hasProtocol, m as isScriptProtocol, n as joinURL, w as withQuery, o as defu, p as sanitizeStatusCode, q as createHooks, h as createError$1, t as toRouteMatcher, r as createRouter$1, v as klona, x as parse$1, y as getRequestHeader, z as destr, A as isEqual, B as setCookie, C as getCookie, D as deleteCookie } from '../runtime.mjs';
import { b as baseURL } from '../routes/renderer.mjs';
import { getActiveHead, CapoPlugin } from 'unhead';
import { defineHeadPlugin } from '@unhead/shared';
import { useRoute as useRoute$1, RouterView, createMemoryHistory, createRouter, START_LOCATION } from 'vue-router';
import { createPersistedState } from 'pinia-plugin-persistedstate';
import { parse, icon, config, text, library } from '@fortawesome/fontawesome-svg-core';
...
const _routes = [
  {
    ...
    component: () => import('./index-C97Br8_0.mjs').then((m) => m.default || m)
  },
  {
    name: "community",
    path: "/community",
    meta: __nuxt_page_meta$2 || {},
    component: () => import('./index-CHwBJYWG.mjs').then((m) => m.default || m)
  },
  {
    name: "index-index",
    path: "/",
    meta: __nuxt_page_meta$1 || {},
    component: () => import('./index-j4zsTO8T.mjs').then((m) => m.default || m)
  },
  {
    name: "music-components-ArtistBox",
    path: "/music/components/ArtistBox",
    component: () => import('./ArtistBox-zDxCXV4l.mjs').then((m) => m.default || m)
  },
  {
    name: "music-components-MusicPlayer",
    path: "/music/components/MusicPlayer",
    component: () => import('./MusicPlayer-DXp-LnTL.mjs').then((m) => m.default || m)
  },
  {
    name: "music-components-RatingSystem",
    path: "/music/components/RatingSystem",
    component: () => import('./RatingSystem-BQ9Gy9xH.mjs').then((m) => m.default || m)
  },
  {
    name: "music-components-TrackBox",
    path: "/music/components/TrackBox",
    component: () => import('./TrackBox-BQgPHskX.mjs').then((m) => m.default || m)
  },
  {
    name: "music",
    path: "/music",
    meta: __nuxt_page_meta || {},
    component: () => import('./index-govGSW2C.mjs').then((m) => m.default || m)
  },
  {
    name: "portfolio",
    path: "/portfolio",
    component: () => import('./index-Dbv8LQNn.mjs').then((m) => m.default || m)
  },
  {
    name: "shop",
    path: "/shop",
    component: () => import('./index-C10sIKMQ.mjs').then((m) => m.default || m)
  }
];
...
function createSetupStore($id, setup4, options = {}, pinia, hot, isOptionsStore) {
  ...
  const setupStore = runWithContext(() => pinia._e.run(() => (scope = effectScope()).run(() => setup4({ action }))));
...
const font_awesome_4Kz3WSwqBj = /* @__PURE__ */ defineNuxtPlugin(({ vueApp }) => {
...
const layouts = {
  blog: () => import('./blog-CE2kJZ2g.mjs').then((m) => m.default || m),
  community: () => import('./community-CnWg6n1o.mjs').then((m) => m.default || m),
  default: () => import('./default-fiHhkoQ0.mjs').then((m) => m.default || m),
  home: () => import('./home-BnAqi6z1.mjs').then((m) => m.default || m),
  music: () => import('./music-DlOo5On1.mjs').then((m) => m.default || m)
};
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404-eFFhDInO.mjs').then((r) => r.default || r));
    const _Error = defineAsyncComponent(() => import('./error-500-BHgHQcxO.mjs').then((r) => r.default || r));
...
export { _export_sfc as _, navigateTo as a, useRuntimeConfig as b, resolveUnrefHeadInput as c, createPinia as d, entry$1 as default, defineStore as e, useRoute as f, injectHead as i, nuxtLinkDefaults as n, resolveRouteObject as r, useRouter as u };
